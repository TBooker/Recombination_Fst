...
d2L <- read.csv('~/work/LinkageCoalescent/Fst_calculator/results/empirical.chr2L.WeirCockerham.MAF0.05.txt', sep = ' ', head = 0)
...
d2L_rates <- read.csv('~/work/LinkageCoalescent/Fst_calculator/RRC_input/RRC_Input_empirical.chr2L.WeirCockerham.MAF0.05.txt.rrc', sep = '\t', head = 0)
...
d2R <- read.csv('~/work/LinkageCoalescent/Fst_calculator/results/empirical.chr2R.WeirCockerham.MAF0.05.txt', sep = ' ', head = 0)
d2R_n <- dim(d2R)[1]
d2R <- d2R[1:(d2R_n-1),]
d2R_rates <- read.csv('~/work/LinkageCoalescent/Fst_calculator/RRC_input/RRC_Input_empirical.chr2R.WeirCockerham.MAF0.05.txt.rrc', sep = '\t', head = 0)
...
d3L <- read.csv('~/work/LinkageCoalescent/Fst_calculator/results//empirical.chr3L.WeirCockerham.MAF0.05.txt', sep = ' ', head = 0)
d3L_n <- dim(d3L)[1]
d3L <- d3L[1:(d3L_n-1),]
d3L_rates <- read.csv('~/work/LinkageCoalescent/Fst_calculator/RRC_input/RRC_Input_empirical.chr3L.WeirCockerham.MAF0.05.txt.rrc', sep = '\t', head = 0)
...
d3R <- read.csv('~/work/LinkageCoalescent/Fst_calculator/results//empirical.chr3R.WeirCockerham.MAF0.05.txt', sep = ' ', head = 0)
d3R_n <- dim(d3R)[1]
d3R <- d3R[1:(d3R_n-1),]
d3R_rates <- read.csv('~/work/LinkageCoalescent/Fst_calculator/RRC_input/RRC_Input_empirical.chr3R.WeirCockerham.MAF0.05.txt.rrc', sep = '\t', head = 0)
...
s2L <- read.csv('~/work/LinkageCoalescent/Fst_calculator/results/drosophilaSimulated.chr2L.fst.csv')
s2L<- s2L[(s2L$BIN_START> 844225)&(s2L$BIN_END< 19946732),]
s2R <- read.csv('~/work/LinkageCoalescent/Fst_calculator/results/drosophilaSimulated.chr2R.fst.csv')
s2R<- s2R[(s2R$BIN_START> 6063980)&(s2R$BIN_END< 20322335),]
s3L <- read.csv('~/work/LinkageCoalescent/Fst_calculator/results/drosophilaSimulated.chr3L.fst.csv')
s3L<- s3L[(s3L$BIN_START> 447386)&(s3L$BIN_END< 18392988),]
s3R <- read.csv('~/work/LinkageCoalescent/Fst_calculator/results/drosophilaSimulated.chr3R.fst.csv')
...
png("~/work/LinkageCoalescent/writeUp/threePanelFigure.png",width = 12, height = 4, res = 300, units = 'in')
